...
def get_random_movie(genres, start_year = 1888, end_year = 2024):
  ...
  rand_page_num = random.randint(1, 20)
  url = f'https://www.filmweb.pl/films/search?genres={genres}&orderBy=popularity&descending=true&startYear={start_year}&endYear={end_year}'
  print(url + f'&page={rand_page_num}')
  res = requests.get(url + f'&page={rand_page_num}')
